...
<!DOCTYPE html>
<style>
.select {margin-bottom: 7.5rem!important; margin-top:1rem!important;}
.select ul{list-style:none; padding-left: 0px;}
.select li{float:left; padding-right: 10px;}
.select li a{ color: black; font-size:14px;font-family: 'Nanum Gothic';}
...
<div class="card-deck">
	<c:forEach items="${popList}" var="ProjectVO">
